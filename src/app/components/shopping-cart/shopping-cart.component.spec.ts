...
describe("ShoppingCartComponent", () => {
      ...
      providers: [
        {
          ...
          useValue: sinon.createStubInstance(ProductsDataService)
        },
        {
          provide: DeliveryOptionsDataService,
          useValue: sinon.createStubInstance(DeliveryOptionsDataService)
        },
  ...
  it("should render gross total of shopping cart", async(
  ...
  it("should empty the cart when empty shopping cart button pressed", async(
    inject([ShoppingCartService], (service: MockShoppingCartService) => {
      const newCart = new ShoppingCart();
